...
public class ErrorEiminaciónProduto extends javax.swing.JDialog {

    public ErrorEiminaciónProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorEiminaciónProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorEiminaciónProduto dialog = new ErrorEiminaciónProduto(new javax.swing.JFrame(), true);
