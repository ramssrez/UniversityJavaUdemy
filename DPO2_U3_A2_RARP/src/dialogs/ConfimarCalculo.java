...
public class ConfimarCalculo extends javax.swing.JDialog {

    public ConfimarCalculo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Estás seguro del Cálculo?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfimarCalculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfimarCalculo dialog = new ConfimarCalculo(new javax.swing.JFrame(), true);
