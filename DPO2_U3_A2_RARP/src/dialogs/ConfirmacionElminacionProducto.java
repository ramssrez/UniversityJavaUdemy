...
public class ConfirmacionElminacionProducto extends javax.swing.JDialog {

    public ConfirmacionElminacionProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Se ha eliminado un producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmacionElminacionProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmacionElminacionProducto dialog = new ConfirmacionElminacionProducto(new javax.swing.JFrame(), true);
