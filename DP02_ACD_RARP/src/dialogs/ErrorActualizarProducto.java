...
public class ErrorActualizarProducto extends javax.swing.JDialog {

    public ErrorActualizarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se actualizo el producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorActualizarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorActualizarProducto dialog = new ErrorActualizarProducto(new javax.swing.JFrame(), true);
