...
public class ErrorIngresarDatos extends javax.swing.JDialog {

    public ErrorIngresarDatos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se han ingresado valores");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorIngresarDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorIngresarDatos dialog = new ErrorIngresarDatos(new javax.swing.JFrame(), true);
