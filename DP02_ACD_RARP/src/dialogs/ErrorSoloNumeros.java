...
public class ErrorSoloNumeros extends javax.swing.JDialog {

    public ErrorSoloNumeros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Solo  agrega números");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorSoloNumeros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorSoloNumeros dialog = new ErrorSoloNumeros(new javax.swing.JFrame(), true);
