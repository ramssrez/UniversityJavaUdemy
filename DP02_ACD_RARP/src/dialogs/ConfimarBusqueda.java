...
public class ConfimarBusqueda extends javax.swing.JDialog {

    public ConfimarBusqueda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Estás seguro de la busqueda?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfimarBusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfimarBusqueda dialog = new ConfimarBusqueda(new javax.swing.JFrame(), true);
