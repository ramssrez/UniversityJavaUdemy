...
public class ErrorEiminacionEmpleado extends javax.swing.JDialog {

    public ErrorEiminacionEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("No eliminado");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se ha eliminado el emplado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorEiminacionEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorEiminacionEmpleado dialog = new ErrorEiminacionEmpleado(new javax.swing.JFrame(), true);
