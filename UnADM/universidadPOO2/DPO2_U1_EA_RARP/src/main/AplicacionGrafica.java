...
public class AplicacionGrafica extends JFrame {
    ...
    public AplicacionGrafica() {
        ...
        etiqueta.setBounds(335, 20, 70, 30);
        contentPanel.add(etiqueta);
        JLabel etiquetaPassword = new JLabel("Contraseña");
        etiquetaPassword.setBounds(335, 170, 150, 150);
        contentPanel.add(etiquetaPassword);
        JLabel etiquetaCorreo = new JLabel("Correo");
        etiquetaCorreo.setIcon(new ImageIcon("/imagenes/back.jpg"));
        etiquetaCorreo.setBounds(335, 70, 70, 30);
        contentPanel.add(etiquetaCorreo);
...
//        contentPanel.add(scroll2);
    ...
    public static void main(String[] args) {
        Princiipal princiipal = new Princiipal();
        princiipal.setVisible(true);
