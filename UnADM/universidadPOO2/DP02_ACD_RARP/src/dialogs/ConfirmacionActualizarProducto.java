...
public class ConfirmacionActualizarProducto extends javax.swing.JDialog {

    public ConfirmacionActualizarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        labelMensaje.setText("Se ha actualizado un producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmacionActualizarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmacionActualizarProducto dialog = new ConfirmacionActualizarProducto(new javax.swing.JFrame(), true);
