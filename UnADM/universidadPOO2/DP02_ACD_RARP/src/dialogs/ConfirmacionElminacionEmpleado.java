...
public class ConfirmacionElminacionEmpleado extends javax.swing.JDialog {

    public ConfirmacionElminacionEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Se ha eliminado un empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmacionElminacionEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmacionElminacionEmpleado dialog = new ConfirmacionElminacionEmpleado(new javax.swing.JFrame(), true);
