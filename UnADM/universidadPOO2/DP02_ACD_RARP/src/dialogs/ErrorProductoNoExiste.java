...
public class ErrorProductoNoExiste extends javax.swing.JDialog {

    public ErrorProductoNoExiste(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No existe este producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorProductoNoExiste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorProductoNoExiste dialog = new ErrorProductoNoExiste(new javax.swing.JFrame(), true);
