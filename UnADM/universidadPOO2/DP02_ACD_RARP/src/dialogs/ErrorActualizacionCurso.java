...
public class ErrorActualizacionCurso extends javax.swing.JDialog {

    public ErrorActualizacionCurso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualización en curso: ");
        ...
        jLabel2.setText("Presiona limpiar para guardar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorActualizacionCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorActualizacionCurso dialog = new ErrorActualizacionCurso(new javax.swing.JFrame(), true);
