...
public class ConfirmacionRegistroProducto extends javax.swing.JDialog {

    public ConfirmacionRegistroProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmacionRegistroProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmacionRegistroProducto dialog = new ConfirmacionRegistroProducto(new javax.swing.JFrame(), true);
