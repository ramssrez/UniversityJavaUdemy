...
public class ErrorIngresarPorcentaje extends javax.swing.JDialog {

    public ErrorIngresarPorcentaje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se ha ingresado porcentaje");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorIngresarPorcentaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorIngresarPorcentaje dialog = new ErrorIngresarPorcentaje(new javax.swing.JFrame(), true);
