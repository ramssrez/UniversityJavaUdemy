...
public class ErrorActualizarEmpleado extends javax.swing.JDialog {

    public ErrorActualizarEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se actualizo el empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorActualizarEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorActualizarEmpleado dialog = new ErrorActualizarEmpleado(new javax.swing.JFrame(), true);
