...
public class ErrorEiminacionProduto extends javax.swing.JDialog {

    public ErrorEiminacionProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se ha eliminado el producto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorEiminacionProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorEiminacionProduto dialog = new ErrorEiminacionProduto(new javax.swing.JFrame(), true);
